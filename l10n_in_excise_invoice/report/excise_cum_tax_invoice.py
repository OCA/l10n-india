...
class report_excice_cum_tax_invoice(osv.AbstractModel):
    _name = 'report.l10n_in_excise_invoice.report_excise_cum_tax'
    _inherit = 'report.abstract_report'
    _template = 'l10n_in_excise_invoice.report_excise_cum_tax'
    _wrapped_report_class = excice_cum_tax_invoice
